define [
  ...
  @Pro.module "Entities", (Entities, App) ->
    ...
    class Entities.AjaxPaginatedCollection extends Backbone.Paginator.requestPager
      server_api:
    ...
    # @event remove:multiple:complete
    #   Emitted after several models have successfully been removed from the collection.
    class Entities.StaticPaginatedCollection extends Backbone.Paginator.clientPager
    ...
    #
    Entities.CreatePaginatedCollectionClass = (collection, opts={}) ->

      superclass = if opts.static
        Entities.StaticPaginatedCollection
      else
        Entities.AjaxPaginatedCollection
